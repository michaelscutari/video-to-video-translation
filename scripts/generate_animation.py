...
keyframes = '/Users/peterbanyas/Desktop/ECE 661/Project 661/ece661-GAN-project/analysis/merged/mufasa_lost/'
...
# save as a .mp4 file
out = cv2.VideoWriter(output_dir + 'mufasa_lost_2.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 30, size)

for frame in frame_array:
    out.write(frame)

out.release()  # Release the VideoWriter object
print(f"Video saved at {os.path.join(output_dir, 'mufasa_lost_2.mp4')}")